...
Both models converge around **0.84 ROC-AUC**, indicating the dataset's signal is largely linear — added model complexity (Random Forest) doesn't meaningfully improve performance. **Logistic Regression was selected as the final model** for its comparable performance, interpretability, and ease of explaining to business stakeholders.
